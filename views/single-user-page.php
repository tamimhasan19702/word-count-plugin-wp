...
$img_url = plugin_dir_path(dirname(__FILE__)) . '../assets/img/ninethree.png';
    ...
    <div class="log-form-row">
            ...
            <table class="record-list" cellspacing="0">
                <?php foreach ($records as $item):
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo esc_url($user_page_url); ?>" class="record-list__user-data-link">See user
                                records -></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
        ...
        <?php else: ?>
            <div class="log-no-records">
                ...
                <p class="log-no-records--caption">If you are looking at your current day and you do not see any record then
                    your role might not be included. Check the <a
                        href="<?php echo $admin_url . '?page=log-settings'; ?>">Settings</a> page for more information.</p>
            </div>
        <?php endif; ?>
    </div>
</section>
