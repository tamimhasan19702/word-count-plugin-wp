...
<?php if (isset($class) && isset($not_data) && !empty($not_data)): ?>
    <div class="<?php echo $class; ?>">
        <p aria-live="polite">
            <?php echo esc_html($not_data['content']); ?>
        </p>
    </div>
<?php endif; ?>
    ...
    <form action="" method="post">
            ...
            <div class="log-form-col">
                <ul class="log-form-checkbox-list">
                    <?php foreach ($roles as $role):
                        ...
                        ?>
                        <li>
                            <input type="checkbox" name="log_roles[]" value="<?php echo strtolower($role['name']); ?>"
                                id="<?php echo $role['name']; ?>" class="log-form-checkbox" <?php echo $checked; ?>>
                            <?php echo $role['name']; ?>
                        </li>
                    <?php endforeach; ?>
                </ul>
        ...
        <div class="log-form-row">
            ...
            <div class="log-form-col--half">
                <ul class="log-form-radio-list">
                    <li>
                        <input type="radio" name="log_display_metabox" value="yes" <?php if (empty($display_dashboard_metabox) || $display_dashboard_metabox == 'yes'):
                            echo "checked";
                        endif; ?>> <?php echo _e('Yes', $trans_key); ?>
                    </li>
                    <li>
                        <input type="radio" name="log_display_metabox" value="no" <?php if ($display_dashboard_metabox == 'no'):
                            echo "checked";
                        endif; ?>> <?php echo _e('No', $trans_key); ?>
                    </li>
                </ul>
            </div>
        </div>
        <div class="log-form-row">
            ...
            <div class="log-form-col--half">
                <ul class="log-form-radio-list">
                    <li>
                        <input type="radio" name="log_send_admin_notification" value="yes" <?php if ($send_admin_email_notification == 'yes'):
                            echo "checked";
                        endif; ?>> <?php echo _e('Yes', $trans_key); ?>
                    </li>
                    <li>
                        <input type="radio" name="log_send_admin_notification" value="no" <?php if (empty($send_admin_email_notification) || $send_admin_email_notification == 'no'):
                            echo "checked";
                        endif; ?>> <?php echo _e('No', $trans_key); ?>
                    </li>
                </ul>
        ...
        <div class="log-form-row">
            <div class="log-form-col">
                <input type="submit" value="<?php echo _e('Update Settings', $trans_key); ?>"
                    class="button button-primary log-submit-button">
            </div>
        </div>
    </form>
</section>